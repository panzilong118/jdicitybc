...
var Job = function (_React$Component) {
  ...
  function Job() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Job.__proto__ || Object.getPrototypeOf(Job)).call.apply(_ref, [this].concat(args))), _this), _this.restoreStyle = (0, _lodash.debounce)(function () {
    ...
    }, _this.setTarget = function (target, targetAnchor) {
      var _this2 = _this,
