...
describe('DatePicker', () => {
  ...
  it('control value after panel closed', () => {
    ...
    expect(wrapper.find('.jc-calendar-input').getDOMNode().value).toBe('2016-11-13 12:12:12');
    selectDate(wrapper, moment('2016-11-14'));
    expect(wrapper.find('.jc-calendar-input').getDOMNode().value).toBe('2016-11-14 12:12:12');
  });
