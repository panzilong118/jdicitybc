...
require('./style/operatingOnlyTop.css');
...
var OperatingOnlyTop = function (_Component) {
  (0, _inherits3.default)(OperatingOnlyTop, _Component);

  function OperatingOnlyTop(props, context) {
    (0, _classCallCheck3.default)(this, OperatingOnlyTop);

    var _this = (0, _possibleConstructorReturn3.default)(this, (OperatingOnlyTop.__proto__ || (0, _getPrototypeOf2.default)(OperatingOnlyTop)).call(this, props, context));
  ...
  (0, _createClass3.default)(OperatingOnlyTop, [{
    ...
    value: function urlMatch(location, href) {
      //href:             /dfsd/sdfs
      //location:                     http://fdjfid.com/sdf/sdfs?idijd=12
      //menuUrl优先匹配
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: { minHeight: this.minHeight + "px" }, className: 'operating-layout-onlytop' },
          _react2.default.createElement(
            _reactHelmet2.default,
            null,
            vName && vName.length > 0 ? _react2.default.createElement(
              'title',
              null,
              vName
            ) : "",
          ...
          _react2.default.createElement(
            'div',
            { className: 'operating-layout-right-onlytop' },
            _react2.default.createElement(
              'div',
  ...
  return OperatingOnlyTop;
}(_react.Component);

exports.default = OperatingOnlyTop;
module.exports = exports['default'];
//# sourceMappingURL=OperatingOnlyTop.js.map