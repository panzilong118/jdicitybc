...
describe('Form', () => {
  it('should remove duplicated user input colon', () => {
    ...
    expect(wrapper.find('.jc-form-item-label label').at(0).text()).not.toContain(':');
    expect(wrapper.find('.jc-form-item-label label').at(1).text()).not.toContain('：');
  });
  ...
  it('should not remove duplicated user input colon when props colon is false', () => {
    ...
    expect(wrapper.find('.jc-form-item-label label').at(0).text()).toContain(':');
    expect(wrapper.find('.jc-form-item-label label').at(1).text()).toContain('：');
  });
  ...
  it('should has dom with .jc-form-item-control-wrapper', () => {
    ...
    expect(wrapper.find('.jc-form-item-control-wrapper').hostNodes().length).toBe(2);
    expect(wrapper.find('.jc-form-item-control-wrapper.jc-col-14').length).toBe(1);
  });
