...
describe('Calendar', () => {
  it('Calendar should be selectable', () => {
    ...
    wrapper.find('.jc-fullcalendar-cell').at(0).simulate('click');
  ...
  it('dates other than in valid range should be disabled', () => {
    ...
    const elem = wrapper.find('[title="February 20, 2018"]').hasClass('jc-fullcalendar-disabled-cell');
  ...
  it('months other than in valid range should be disabled', () => {
    ...
    expect(wrapper.find('[title="Jan"]').at(0).hasClass('jc-fullcalendar-month-panel-cell-disabled')).toBe(true);
    expect(wrapper.find('[title="Feb"]').at(0).hasClass('jc-fullcalendar-month-panel-cell-disabled')).toBe(false);
    expect(wrapper.find('[title="Jun"]').at(0).hasClass('jc-fullcalendar-month-panel-cell-disabled')).toBe(true);
  ...
  it('months other than in valid range should not be shown in header', () => {
    ...
    wrapper.find('.jc-fullcalendar-year-select').hostNodes().simulate('click');
    wrapper.find('.jc-select-dropdown-menu-item').first().simulate('click');
    wrapper.find('.jc-fullcalendar-month-select').hostNodes().simulate('click');
    // 2 years and 11 months
    expect(wrapper.find('.jc-select-dropdown-menu-item').length).toBe(13);
  });
